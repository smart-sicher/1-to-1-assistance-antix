...
--button=gtk-close \
--text 'WARNING: \
Close full screen mode with F11 only works if keyboard shortcuts under View in Vinagre are activated. \
\
IMPORTANT: \
Please use the key combination "Ctrl+Alt+Backspace", if you are trapped in full screen mode. \
\
INFO: \
For a successful vnc reverse connection, “Reverse Connection” must be activated in Vinagre. There you will also find your public IP for the assistance receiver. '
