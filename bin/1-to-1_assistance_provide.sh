...
--button=gtk-close \
--text 'WARNING: \
By default, Vinagre disable local keyboard shortcuts and \
keyboard shortcuts are forwarded to the remote computer. \
Close full screen mode with F11 only works \
if keyboard shortcuts under View in Vinagre are activated. \
\
IMPORTANT: \
...
There you will also find your public IP for the assistance receiver. '
