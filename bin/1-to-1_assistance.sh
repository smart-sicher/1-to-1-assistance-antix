...
Creates a connection between two Linux systems and enables the
...
References:
   ...
   http://aika.bplaced.net/1-to-1_vnc-help/
...
# Location of profile file for vnc viewer
...
yad --title ' Use 1-to-1 VNC help? ' \
--window-icon=gtk-about \
--width=700 --height=580 \
--button=gtk-close \
--text-info --wrap --margins=20 < /usr/share/antiX/1-to-1_assistance.txt
